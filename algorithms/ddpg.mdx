---
title: "DDPG: Deep Deterministic Policy Gradient for Continuous Actions"
sidebarTitle: "DDPG"
description: "Implement DDPG — an off-policy actor-critic algorithm for continuous action spaces — using target networks, experience replay, and Ornstein-Uhlenbeck noise."
---
